...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/01_Left_Menu.png[]
. It will list the VMs running in the current project.
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/25_List_VMs.png[]
. Press on the top-right the button *Create* and select *From template*
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/26_From_Template.png[]
. Scroll down and select *Microsoft Windows Server 2019 VM* tile.
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/27_Windows_2k9_Tile.png[]

. A dialog will appear showing the default configuration related to the template.
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/28_Windows_2k9_Dialog.png[]

. Press *Customize VirtualMachine* to specify the parameters to be used for the provisioning.
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/29_Windows_2k9_Parameters.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/30_Windows_2k9_Parameters_Filled.png[]

. Switch to the *Scripts* tab and press *Edit* on the `Sysprep` section
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/30_Windows_2k9_Scripts.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/30_Windows_2k9_Sysprep.png[]

. Press *Create VirtualMachine*
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/31_Windows_2k9_Create.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/32_Windows_2k9_Provisioning.png[]

. After a few minutes, the Virtual VM will be in `Running` status. Switch to the *Console* tab:
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/33_Windows_2k9_Console.png[]
+
[NOTE]
...
image::/content/modules/ROOT/bootcamp/assets/images/windows_migrate_fix/ocp-terminal.png[]
