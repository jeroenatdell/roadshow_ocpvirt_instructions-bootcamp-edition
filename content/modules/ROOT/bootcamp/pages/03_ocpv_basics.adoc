...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/01_Left_Menu.png[Navigation Menu,136,266]
+
[NOTE]
====
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/51_vm_list.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/50_create_new_project.png[]
.. In the *Name* field, type `vmexamples` to name the project, then click *Create*.
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/03_Create_Project.png[]

== Create a Linux virtual machine

. From the Virtual Machines inventory, click *Create VirtualMachine*
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/53_create_vm_button.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/04_Create_VM_Templates.png[]

. Select the *Fedora VM* tile, and a dialog opens.
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/05_Create_VM_Quick.png[]

. Change the name to `fedora01` and press *Quick create VirtualMachine*:
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/05_Create_VM_Quick_Name.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/06_Fedora_Running.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/09_Fedora_Events.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/10_Fedora_Details.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/13_Fedora_Console.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/14_Fedora_Console_Show_Password.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/15_Fedora_Network.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/16_Fedora_Disk.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/17_Fedora_CPU_Memory.png[]

. To review the guest customization, mount the `cloud-init` disk:
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/21_Fedora01_Cloud_Init.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/19_Fedora_Agent.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/19_Fedora_Agent_Details.png[]
+
* Hostname
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/19_Fedora_Metrics.png[]

== Using virtctl for VMs 

. Please ensure you have ssh'd to the Bastion VM(via sudo ssh root@192.168.123.100)
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Pods_Migration/17_VM_Info_Node.png[]

. Using the menu *Actions*, press *Migrate*
+
image::/content/modules/ROOT/bootcamp/assets/images/Pods_Migration/19_VM_Dialog_Migrate.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Pods_Migration/21_Migrated.png[]
...
options:
+
image::/content/modules/ROOT/bootcamp/assets/images/Pods_Migration/30_VM_Actions_List.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Pods_Migration/31_VM_Stopped.png[]
. Clicking on *Actions*, the option *Start* appears, and the options *Restart* and *Pause* are greyed out. 
+
image::/content/modules/ROOT/bootcamp/assets/images/Pods_Migration/32_VM_Actions_List_Stopped.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Pods_Migration/33_VM_Actions_Paused.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/create_overview_413.png[]
+
...
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/create_quickstarts413.png[]
====
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/create_overview_consumers413.png[]
