...
+
image::/content/modules/ROOT/bootcamp/assets/images/Backup/00_Left_Menu.png[]

. Review the *Provided APIs* available. In this module, the `Backup` and `Restore` functions will be used.
+
image::/content/modules/ROOT/bootcamp/assets/images/Backup/01_Overview.png[]

. Navigate to the tab *DataProtectionApplication*. This object represents the configuration of the deployed OADP instance.
+
image::/content/modules/ROOT/bootcamp/assets/images/Backup/02_DPA.png[]

. Select `oadp-dpa` and review the _YAML_ definition
+
image::/content/modules/ROOT/bootcamp/assets/images/Backup/03_OADP_YAML.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Backup/04_Backup_Tab.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Backup/05_Backup_Completed.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Backup/06_Restore_Tab.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Backup/07_Restore_Completed.png[]

. Navigate back to *Virtualization* -> *Virtual Machines* and ensure the `fedora02` was restored.
+
image::/content/modules/ROOT/bootcamp/assets/images/Backup/08_VM_Restored.png[]
