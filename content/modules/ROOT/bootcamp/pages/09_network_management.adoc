...
+
image::/content/modules/ROOT/bootcamp/assets/images/Networking/01_NAD_Dashboard.png[]
+
[IMPORTANT]
====
...
* *Bridge Name*: `br-flat`
+
image::/content/modules/ROOT/bootcamp/assets/images/Networking/02_NAD_Create.png[]
+
[NOTE]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Networking/03_NAD_Created.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Networking/04_VM_Network_Tab.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Networking/05_VM_Network_Attach.png[]

. Use the *Actions* menu to restart the VM. After rebooting, navigate to the *Console* tab:
+
image::/content/modules/ROOT/bootcamp/assets/images/Networking/06_VM_Network_Console.png[]
+
