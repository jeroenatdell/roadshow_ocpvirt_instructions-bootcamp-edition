...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/54_vm_management_navigation.png[]

. Click the *Configuration* tab, this is the entry point to obtain information about the resources of the Virtual Machine. 
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/55_configuration_tab_nav.png[]
+
It includes five subtabs:
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/56_config_tab_nav_2.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/20_Network_Tab.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_PVC/21_Disks_Tab.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Pods_Migration/35_VM_Resources.png[]

. A dialog will appear to specify new values for the _CPU_ and _Memory_.
+
image::/content/modules/ROOT/bootcamp/assets/images/Pods_Migration/36_VM_Resources_Dialog.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Pods_Migration/37_VM_Resources_Warning.png[]
