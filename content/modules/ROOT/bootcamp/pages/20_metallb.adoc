...
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/00_layer2.png[]
...
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/00_bgp.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/01_Operator_Installed.png[]

. Review the *Provided APIs* on the Details tab
+
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/02_Review_Operator.png[]

. Select the tab *MetalLB* to ensure the deployment is installed and configured correctly
+
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/03_Review_Operator_MetalLB.png[]
////
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/40_navigation.png[]

. Switch the tab *IPAddressPool* (you may need to scroll the tabs to the right to see it) and press *Create IPAddressPool*
+
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/21_navigation.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/09_MetalLB_IPAddressPool_Defined.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/22_navigation.png[]

. Indicate the name `l2-adv-webapp` and under section _ipaddressPools_ specify the value `ip-addresspool-webapp` as is shown:
+
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/10_MetalLB_L2Advertisement.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/11_Services.png[]
+
[IMPORTANT]
====
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MetalLB/12_Service_created.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/OCP_Terminal_Icon.png[]

. A console in the bottom part of the screen appears
+
image::/content/modules/ROOT/bootcamp/assets/images/OCP_Terminal.png[]
