...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/100_vSphere_VM_List.png[]
+
[NOTE]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/101_vSphere_Network.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/102_vSphere_Datastore.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/91_MTV_Providers.png[]
+
[TIP]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/92_MTV_Provider_list.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/93_MTV_Create_Provider.png[]
+
// WKTBD: replace with student's credentials
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/94_MTV_Fill_Dialog.png[]
.  Press *Create* and wait till the *Status* column is changed to `Ready`
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/95_MTV_Provider_Added.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/96_MTV_NetworkMaps.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/97_Add_VMWARE_Mapping_Network.png[]

. Ensure the created mapping has the *Status* `Ready`
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/98_List_VMWARE_Mapping_Network.png[]

. Navigate in the left menu to *Migration* -> *StorageMaps for virtualization* and press *Create StorageMap*
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/99_MTV_StorageMaps.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/100_Add_VMWARE_Mapping_Storage.png[]

. Ensure the created mapping has the *Status* `Ready`
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/101_List_VMWARE_Mapping_Storage.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/102_Create_VMWARE_Plan.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/52_General_VMWARE_Plan.png[]

. On the next step, select `All datacenters`  and press *Next*
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/53_VM_Filter_VMWARE_Plan.png[]

. On the next step select the three VMs: database, winweb01 and winweb02. Press *Next*:
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/54_VM_Select_VMWARE_Plan.png[]

. On the *Network mapping* step select `mapping-segment` and press *Next*
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/55_Network_VMWARE_Plan.png[]

. On the *Storage mapping* step select `mapping-datastore` and press *Next*
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/56_Storage_VMWARE_Plan.png[]

. Press *Next* on the steps *Type* and *Hooks*

. Review the configuration specified and press *Finish*
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/57_Finish_VMWARE_Plan.png[]

. Ensure the status of the plan is *Ready*
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/58_Ready_VMWARE_Plan.png[]

. Press *Start* to begin the migration of the three VMs

. After around 10 minutes the migration is completed
+
image::/content/modules/ROOT/bootcamp/assets/images/MTV/59_Completed_VMWARE_Plan.png[]
+
[IMPORTANT]
====
