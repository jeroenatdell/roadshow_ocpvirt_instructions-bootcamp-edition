...
image::/content/modules/ROOT/bootcamp/assets/images/Storage/00_disk_concepts.png[]
...
xref:27_steps_to_disable_os_images.adoc[Steps to Disable OS Images in Virtualization Operator]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/00_Left_Menu.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/01_Select_Project.png[]

. List the boot sources that OpenShift Virtualization automatically created.
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/02_List_PVCs.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/03_PVC_Info.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/04_List_PVCs_VMs.png[]

. Select the `fedora02` to obtain information
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/05_PVC_VM_Info.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/07_PV_List.png[]

. Now navigate to *Virtualization* -> *Bootable volumes* to obtain a list of the available volumes
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/08_List_Bootable_Volumes.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/09_VM_Overview.png[]

. Navigate to the *Snapshots* tab
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/10_VM_Snapshots_Tab.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/11_VM_Snapshot_Dialog.png[]

. Press *Save* and wait till the _Snapshot_ has been created and the *status* shows as `Succeeded`
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/12_VM_Snapshot_Taken.png[]

. Press the three dots and check that the *Restore* option is greyed out because the VM is running
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/13_VM_Restore_Disabled.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/14_VM_Crashed.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/15_VM_Restore.png[]

. In the dialog shown, press *Restore*
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/16_VM_Restore_Dialog.png[]

. Wait until the VM is restored, and then start the VM 
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/17_VM_Restored.png[]

. Verify that the VM is booting correctly again.
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/18_VM_Running.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/19_VM_Clone_Dialog.png[]
+
[NOTE]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Storage/20_VM_Cloned.png[]
+
[IMPORTANT]
