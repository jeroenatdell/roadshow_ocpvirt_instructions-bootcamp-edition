...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/00_VMs.png[]
+
[NOTE]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/00_Create.png[]

. From the pre-defined templates, select the *Fedora VM* tile:
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/00_Catalog.png[]

. In the dialog that opens, click *Customize VirtualMachine*. 
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/00_Fedora.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/01_Create_VM_Boot_Source.png[]
+
Press *Next*

. Review the *Overview* tab with the default configuration from the template
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/02_Wizard_General.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/02_Wizard_Scheduling.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/03_Wizard_Networking.png[]

. Click the three vertical dots icon to edit `default`, and review the default options:
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/03_Wizard_Networking_Options.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/04_Wizard_Storage.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/04_Wizard_Storage_settings.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/05_Wizard_Scripts.png[]
+
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/05_Wizard_Scripts_Password.png[]

. Press *Create VirtualMachine* ensuring the option *Start this VirtualMachine after creation* is checked.
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/06_Wizard_Review.png[]
+
[NOTE]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/09_Template_List.png[]

. Press *Create Template* and review auto filled YAML code
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/10_Template_YAML.png[]
+
[NOTE]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/11_Template_YAML_parameters.png[]

. Press *Create* and review the template details
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/12_Template_details.png[]

. Navigate to *Virtualization* -> *Catalog* and filter by keyword `example`. Select the project `vmexamples`
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/13_Catalog.png[]

. Press *Customize VirtualMachine* and specify the name `fedora03` and the password `r3dh4t1!`. Press *Next*
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/14_Catalog_Create_VM.png[]

. Press *Create VirtualMachine* in the next screen.
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/15_Catalog_Create_VM_Review.png[]
...
+
image::/content/modules/ROOT/bootcamp/assets/images/Create_VM_URL/16_Ephemeral_Disk.png[]
