...
+
image::/content/modules/ROOT/assets/images/module-01/01_Compute_Nodes.png[link=self, window=blank]
+
...
+
image::/content/modules/ROOT/assets/images/module-01/02_Worker0_Information.png[link=self, window=blank]
+
...
+
image::/content/modules/ROOT/assets/images/module-01/03_Worker0_Details.png[link=self, window=blank]
...
+
image::/content/modules/ROOT/assets/images/module-01/04_BMHosts.png[link=self, window=blank]
+
...
+
image::/content/modules/ROOT/assets/images/module-01/05_Worker0_BMHost.png[link=self, window=blank]
+
...
+
image::/content/modules/ROOT/assets/images/module-01/06_Add_Host_Red.png[link=self, window=blank]
+
...
+
image::/content/modules/ROOT/assets/images/module-01/07_Create_Host_Red.png[link=self, window=blank]
+
...
+
image::/content/modules/ROOT/assets/images/module-01/08_Worker4_Summary_1.png[link=self, window=blank]
+
...
+
image::/content/modules/ROOT/assets/images/module-01/09_Worker4_Summary_2.png[link=self, window=blank]
+
...
----
+
image::/content/modules/ROOT/assets/images/module-01/09a_Worker4_Yaml_Edit.png[link=self, window=blank]
+
...
+
image::/content/modules/ROOT/assets/images/module-01/10_Machinesets.png[link=self, window=blank]
+
. Click on the *three-dot* menu on the top-right side, and select *Edit Machine count* from the dropdown menu.
+
image::/content/modules/ROOT/assets/images/module-01/11_Edit_Machine_Count.png[link=self, window=blank]
+
. A new menu will appear showing the current machine count of *3*, click the plus (+) sign to increase the machine count to *4*.
+
image::/content/modules/ROOT/assets/images/module-01/12_Edit_Machine_Count_4.png[link=self, window=blank]
+
. You will be returned to the MachineSets page, and you can now see that the count of machines is 3/4 machines.
+
image::/content/modules/ROOT/assets/images/module-01/13_Machine_Count_3_4.png[link=self, window=blank]
+
...
+
image::/content/modules/ROOT/assets/images/module-01/14_Worker_4_Provisioning.png[link=self, window=blank]
+
. Once provisioning is complete you will see the node listed with it's Phase set to *Provisioned as node*.
+
image::/content/modules/ROOT/assets/images/module-01/15_Provisioned_As_Node.png[link=self, window=blank]
+
...
+
image::/content/modules/ROOT/assets/images/module-01/16_All_Nodes.png[link=self, window=blank]
+
. We can also click directly on *worker4* under the *Name* column to see it's current status.
+
image::/content/modules/ROOT/assets/images/module-01/17_Worker_4_Details.png[link=self, window=blank]
+
